...
These guidelines are intended to be read alongside our CODE_OF_CONDUCT.md. Where the two overlap, the Code of Conduct takes precedence.
...
2. Contact the maintainer privately via the email listed on the maintainer's GitHub profile, or open a confidential issue if the platform supports it.
3. Include:
